...
gulp.task('local:server', function () {
  ...
  var middleware = [
    ...
    connect.static(settings.src.app),
    connect.directory(settings.src.app)
  ],
...
gulp.task('js:hint', function() {
  ...
  console.log('-------------------------------------------------- JS - HINT');
  var stream = gulp.src([settings.src.app + 'app.js', settings.src.app + '*.js' +
                         settings.src.js + 'app.js', '!' + settings.src.js + 'libs/*.js', settings.src.js + '**/*.js'])
...
gulp.task('concat:js', ['js:hint'], function () {
  ...
  gulp.src([settings.src.js + 'libs/*.js',
           settings.src.app + 'app.js', settings.src.app + '*.js',
           settings.src.js + 'app.js', settings.src.js + '*.js', settings.src.js + '**/*.js'])
    .pipe(concat('all.js'))
...
gulp.task('convert:scss', function () {
  ...
  var stream = gulp.src(settings.src.css + 'app.scss')
...
gulp.task('concat:css', ['convert:scss'], function () {
  ...
  gulp.src([settings.src.css + 'fonts.css', settings.scss + 'app.css', settings.src.css + '*.css'])
    .pipe(concat('app.css'))
...
gulp.task('watch', function () {
  ...
  var jsFiles    = gulp.watch([settings.src.app+'*.js', settings.src.js + '*.js',    settings.src.js + '**/*.js'],    ['concat:js']);
...
gulp.task('clean:js', function () {
  ...
  gulp.src([settings.build.src], {read: false})
      .pipe(clean({force: true}));
